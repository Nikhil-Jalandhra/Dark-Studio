...
function Slider() {
  ...
  return (
    <div className='w-full h-screen relative'>
        ...
        <div className='w-full flex justify-between items-center px-[40px] h-screen'>
            <div className='w-[80px] h-[480px] flex justify-center items-center border-[1px] border-gray-800'><TfiArrowLeft/></div>
            <div className='w-[80px] h-[480px] flex justify-center items-center border-[1px] border-gray-800'><TfiArrowRight/></div>
        </div>
